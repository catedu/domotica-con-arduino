...
Como Arduino no tiene valores de salida analógicos, utilizaremos los pines PWM para simular tensiones variables de salida ¿no sabes lo que es PWM? eso es que no te has leido esto.
